        ...
        <div class='flex flex-col w-full min-h-screen items-center justify-start bg-[#F8F8F8]'>
            ...
            <div class='flex flex-col w-full px-6 h-full'>
                ...
                <div class='w-full h-auto flex flex-col items-center justify-center mb-16'>
                    ...
                    <div class='w-1/2 text-center text-4xl font-bold mb-10'>We're providing the best and assuring your safety</div>
                    <div class='flex flex-row gap-8 w-11/12 mb-8'>
                        <div class='w-1/2 h-36 bg-white shadow rounded-2xl'></div>
                        <div class='w-1/2 h-36 bg-white shadow rounded-2xl'></div>
                    </div>
                ...
                <div class='rounded-3xl flex text-center w-full min-h-[36rem] items-start bg-[#192939] relative p-10 mb-16'>
                    Top Properties Section Here
                </div>
            </div>
        </div>
    )
