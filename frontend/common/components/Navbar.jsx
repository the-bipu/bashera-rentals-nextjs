...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 z-40 w-full backdrop-blur h-[90px] flex items-center transition-colors duration-500 lg:z-50 border-b border-slate-900/10 supports-backdrop-blur:bg-white/60 bg-transparent ${isActive ? 'active' : ''}`}>
